...
1.【登录页】：输入用户名密码点击登录跳转到系统首页

2.【首页】系统资源占用情况介绍、天气预报介绍

3.【设备管理】

​	3.1 支持根据设备名称模糊查询/新增/修改/删除设备信息

​	3.2 设备如何接入平台，实时状态演示

​	3.3 详细配置页展示 、可配置录像计划 用于后面的设备回放

4.【主预览——实时预览】

​	4.1 在线设备选择、开始预览、音量控制、全屏、云台控制、高级显示设置、抓图、录制、停止预览

​	4.2【抓图记录】在线查看抓图，下载抓图，删除抓图

​	4.3【录像管理】在线查看录制的视频，音量控制，全屏，倍速播放

5.【设备回放】

​	5.1 设备选择、选择开始回放时间：2024-03-22   选择结束回放时间：2024-03-23    点击开始回放， 抓图、录制、支持查看录制记录

6.【报警中心】

​	6.1 左侧支持选择设备列表，支持通过设备名称动态模糊搜索，点击左侧设备右侧会展示对应设备的报警记录，可以查看报警的抓图，类型，报警时间，状态、操作栏支持处理报警记录，可以查看报警当时的视频（10s）并给出对应的描述，处理后状态会变更成已处理；
